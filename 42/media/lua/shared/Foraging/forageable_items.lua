...
local function onAddForageDefs(forageSystem)
  ...
  snackList = {
    ...
    {Type = "KoreanSnack.KOnionRings", snowChance = -10, minCount = 1, maxCount = 1, xp = 5, categories = "Garbage", DeepForest = 0, Forest = 0, Vegitation = 0, FarmLand = 0, Farm = 0, TrailerPark = 3, TownZone = 5, ForagingNav = 2},
